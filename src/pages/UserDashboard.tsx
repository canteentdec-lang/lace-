...
import { Play, Square, Loader2, CheckCircle2, Clock, TrendingUp, Package, ClipboardList } from 'lucide-react';
import { formatTime, formatDate, cn } from '../lib/utils';
import { motion, AnimatePresence } from 'motion/react';
import RawMaterialRequest from './user/RawMaterialRequest';
...
export default function UserDashboard({ user }: UserDashboardProps) {
  ...
  const [activeTab, setActiveTab] = useState<'work' | 'raw_material'>('work');
  ...
  return (
    <div className="max-w-md mx-auto space-y-6 pb-12">
        ...
        <div className="flex bg-white p-1.5 rounded-2xl border border-gray-100 shadow-sm">
          <button
            ...
            className={cn(
              ...
              activeTab === 'work' ? "bg-primary text-white shadow-md" : "text-gray-500 hover:bg-gray-50"
            )}
          >
            <Clock size={18} />
            Work
          ...
          <button
            ...
            className={cn(
              "flex-1 flex items-center justify-center gap-2 py-3 rounded-xl text-sm font-bold transition-all",
              activeTab === 'raw_material' ? "bg-primary text-white shadow-md" : "text-gray-500 hover:bg-gray-50"
            )}
          >
            <Package size={18} />
            Raw Material
      ...
      {activeTab === 'raw_material' && user.role === 'manager' ? (
        <RawMaterialRequest />
      ) : (
        /* Main Action Card */
